...
class RankBoostingVLR  extends \Elementor\Widget_Base
{

    public function get_name()
    {
        return 'Rank Boosting VLR';
    }

    public function get_title()
    {
        return __('Rank Boosting VLR', 'artisansweb-elementor-add-on');
    }
...
?>
            ...
            <form action="https://boostingmarket.com/en/cart/3db9e85351f99b009944b68864a8afa0" method="post" class="row form formAjax formAjax-change align-items-start packDetails" id="formPack">
                <input type="hidden" name="basePathImg" value="/images/app/icons/packs_and_ranks/valorant-boost/ranks/">
                <input type="hidden" name="imgRankDivision" value="1">
                <input type="hidden" name="game_id" value="13">
                <input type="hidden" name="boosting_pack_id" value="59">
                                            ...
                                            <div class="row align-items-center justify-content-center mb-3">
                                                <div class="col-12">
                                                    ...
                                                    <div class="row align-items-center justify-content-center mb-3">
                                                            ...
                                                            <fieldset>
                                                                <div class="form-select">
                                                                    <select class="form-control" name="current_rank" required="">
                                                                        ...
                                                                        <option value="10">Ascendant</option>
                                                        ...
                                                        <div class="col-12  col-md-5  checkVisibility">
                                                            <fieldset>
                                                                <div class="form-select">
                                                        ...
                                                        <div class="col-12 checkVisibility d-none">
                                                    ...
                                                    <div class="row align-items-center justify-content-center mb-3">
                                                        ...
                                                        <div class="col-12 checkVisibility d-none">
                                                            <div class="row align-items-center">
                                                                ...
                                                                <div class="col-12 col-md-5">
                                                                    <fieldset>
                                                                        <input type="number" class="form-control text-center" name="desired_lp_master" placeholder="" value="20" _min="20" max="900" required="">
                                                                        <span class="invalid-feedback" role="alert"></span>
                                                                    </fieldset>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="col-12 col-md-6 checkVisibility">
                                                    ...
                                                    <div class="row justify-content-center">
                                                        <div class="col-12  col-md-8 ">
                                                            <fieldset>
                                                                <div class="form-select">
                                                                    <select class="form-control" name="current_lp" required="">
                                                                        <option value="">Select Current RR *</option>
                        ...
                        <div class="col-12 px-0">
                            ...
                            <div class="row mx-0 background--color-black-5">
                                <div class="col-12 p-3">
                                    <div class="row">
                                        <div class="col-12 form-check form-check-switch mb-3">
                                            ...
                                            <label for="extraOption1" class="trackEvent" data-name="Live Streaming" data-action="click" data-category="customExtraOption">
                                                ...
                                                Live Streaming
                                                <span class="color-orange ml-1">15%</span>
                                    ...
                                    <div class="row">
                                        <div class="col-12 form-check form-check-switch mb-3">
                                            <input type="checkbox" name="extra_options[]" value="10" id="extraOption10">
                                            <label for="extraOption10" class="trackEvent" data-name="High Kill Count" data-action="click" data-category="customExtraOption">
                                                <span class="switcho "></span>
                                                High Kill Count
                                                <span class="color-orange ml-1">50%</span>
                                                <span class="tooltipe ml-1" data-toggle="tooltipe" data-placement="right" title="" tabindex="0" data-trigger="hover" data-original-title="Each game of your order will be completed obtaining a 3+ KDA or more from the booster who plays on it.">
                                                    <i class="fa fa-info-circle"></i>
                                                </span>
                                            </label>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12 form-check form-check-switch mb-3">
                                            ...
                                            <label for="extraOption6" class="trackEvent" data-name="DuoQ" data-action="click" data-category="customExtraOption">
                                                <span class="switcho "></span>
                                                DuoQ
                                                <span class="color-orange ml-1">70%</span>
                                    ...
                                    <div class="row">
                                        <div class="col-12 form-check form-check-switch mb-3">
                                            <input type="checkbox" name="extra_options[]" value="16" id="extraOption16">
                                            <label for="extraOption16" class="trackEvent" data-name="Agent Preferences" data-action="click" data-category="customExtraOption">
                                                <span class="switcho "></span>
                                                Agent Preferences
                                                <span class="isFree color-orange ml-1">FREE</span>
                                                <span class="tooltipe ml-1" data-toggle="tooltipe" data-placement="right" title="" tabindex="0" data-trigger="hover" data-original-title="Your order shall be completed by the booster assigned to it using specific Agents of your choice.">
                                                    <i class="fa fa-info-circle"></i>
                                                </span>
                                            </label>
                                        </div>
