...
class NormalAramWR  extends \Elementor\Widget_Base
{

    public function get_name()
    {
        return 'Normal Aram WR';
    }

    public function get_title()
    {
        return __('Normal Aram WR', 'artisansweb-elementor-add-on');
    }
    ...
    public function get_script_depends()
    {
        ...
        wp_register_script('ajak-file', plugins_url('assets/ajak.js', __DIR__));
        return [
            'widget-script-1',
            'js-file',
            'ajak-file'
...
?>
            ...
            <form action="https://boostingmarket.com/en/cart/3db9e85351f99b009944b68864a8afa0" method="post" class="row form formAjax formAjax-change align-items-start packDetails" id="formPack">
                ...
                <input type="hidden" name="boosting_pack_id" value="61">
                            ...
                            <div class="row">
                                <div class="col-12">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-12">
                                                    ...
                                                    <p class="paragraph-4 color-grey">
                                                        Please select your Current <span>Rank</span>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <fieldset class="">
                                                        <div class="form-select">
                                                            <select class="form-control" name="current_division" required="">
                                                                ...
                                                                <option value="0100">Master 0 - 100 LP</option>
                                                                <option value="100200">Master 100 - 200 LP</option>
                                                                <option value="200300">Master 200 - 300 LP</option>
                                                                <option value="300400">Master 300 - 400 LP</option>
                                                                <option value="400500">GrandMaster 400 - 500 LP</option>
                                                                <option value="500600">GrandMaster 500 - 600 LP</option>
                                                                <option value="600700">GrandMaster 600 - 700 LP</option>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-12">Normal Aram WR
                                            <div class="row align-items-center rowRangeSlider">
                                                ...
                                                <div class="col-12 col-md-8">
                                                    <input class="rangeSlider rangeSlider-single" type="text" name="games_total" />
                                                </div>
                                                <div class="col-2 d-none d-md-block text-center">
                                ...
                                <div class="col-12 py-3">
                                    <div class="row mb-3 align-items-center justify-space-around">
                                        ...
                                        <div class="col-12 col-md-4 pl-md-1 mb-1 text-center">
                                            <div class="form-select">
                                                <a class="btn btn-primary btn-small addCoupon checkPricenetwin">
                                                    Check Price
                                                </a>
                                            </div>
                                        </div>
