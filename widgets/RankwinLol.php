...
class RankWin_Lol  extends \Elementor\Widget_Base
{
    ...
    {
        return __('Rank Win Lol', 'artisansweb-elementor-add-on');
    }
...
?>
            ...
            <form action="https://boostingmarket.com/en/cart/3db9e85351f99b009944b68864a8afa0" method="post" class="row form formAjax formAjax-change align-items-start packDetails" id="formPack">
                ...
                <input type="hidden" name="boosting_pack_id" value="11">
                                            ...
                                            <div class="row mb-5">
                                                <div class="col-12 mb-3">
                                                    <div class="row">
                                                        <div class="col-12 col-md-6">
                                                            <p class="heading-2">
                                                                Numbers of <span>Wins</span>
                                                            </p>
                                                        </div>
                                                        <div class="col-12 col-md-6 text-right">
                                                            <p class="heading-2">
                                                                <span class="currentWins">0</span> Wins
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="row align-items-center justify-content-center rowRangeSlider">
                                                        ...
                                                        <div class="col-11 col-md-8">
                                                            <div class="slider slider-horizontal" id="">
                                                                ...
                                                                <div class="slider-handle min-slider-handle round" role="slider" aria-valuemin="0" aria-valuemax="6" aria-valuenow="0" tabindex="0" style="left: 0%;"></div>
                                                                <div class="slider-handle max-slider-handle round hide" role="slider" aria-valuemin="0" aria-valuemax="6" aria-valuenow="0" tabindex="0" style="left: 0%;"></div>
                                                            </div><input class="rangeSlider rangeSlider-single" type="text" name="wins_total" data-value="0" value="0" style="display: none;">
                                                        </div>
                                                        <div class="col-2 d-none d-md-block text-center">
